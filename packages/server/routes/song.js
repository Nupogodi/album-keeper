...
// @POST create a new song without an album
// Desc: Private
// router.post('/add', requireAuth, async (req, res, next) => {
// try {
//   const userID = req.user._id;

//   const { song_title, song_duration, artist } = req.body;

//   let user = await User.findOne({ _id: userID });
//   let artist = await Artist.findOne({ artist_name: artist, user: userID });
...
//   album.song_list.push(song);
//   artist.song_list.push(song);
//   user.song_list.push(song);
